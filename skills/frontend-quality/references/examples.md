...
| Failed bulk update | Toast “All updated” and clear every selection | Report successful and failed records separately with persistent access to failure details. Follow the existing selection policy; a result report may support recovery after selection is cleared. Offer retry only when supported. |
